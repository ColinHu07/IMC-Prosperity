...
POSITION_LIMIT = 50  # Both products (Prosperity R1 cap; matches research)
...
PEPPER_PASSIVE_SIZE = 50       # Full position-limit; PEPPER benefits from deep quotes
PEPPER_MAX_TAKE_PER_TICK = 50  # = position limit; PEPPER's edge is speed-to-max-long
